...
namespace hospital_web_api.Controllers
{
    ...
    {
        private readonly SpecialityContext _context;

        public SpecialitiesController(SpecialityContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Speciality>>> GetSpecialitys()
        {
            return await _context.Specialitys.ToListAsync();
        }
        ...
        {
            _context.Specialitys.Add(speciality);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.Specialitys.Any(e => e.id == id);
        }
    }
}
